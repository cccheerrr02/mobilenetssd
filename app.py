...
lineaccesstoken = 'uoIngpuJZdb6rUG70XjWwBU6mui6FkIpmFHTSJgwy7VYd3YBNg6efUT+kK26uT2V60vY+GjAtrSY6h/iXH7jt0i11g+hVAGOMwQrjL1YoQSQi40b7y+MgLPckSr8jqu/mdrUGkxKW857lK4sW8rsVgdB04t89/1O/w1cDnyilFU='
...
def event_handle(event,json_line):
    ...
    if msgType == "text":
        ...
        if (msg == "สวัสดี") :
            ...
            replyObj = TextSendMessage(text="กินจ้า หิวไม่ไหว")
            line_bot_api.reply_message(rtoken, replyObj)
        elif (msg == "อยากไปโรงเรียนไหม")  :  
            replyObj = TextSendMessage(text="อยากสิ อยากมากด้วย")
            line_bot_api.reply_message(rtoken, replyObj)
        elif msg == "covid" :
            ...
            url = "https://dialogflow.cloud.google.com/v1/integrations/line/webhook/e95501f9-2f28-44aa-99d9-2be35ecea6cf"
